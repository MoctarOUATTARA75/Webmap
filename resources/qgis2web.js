...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32630',
            //extent: [223974.586903, 1038897.898845, 1092611.122192, 1675116.628907],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([688657.839391, 1430750.798497, 1268071.325698, 1764765.631780], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">CARTOGRAPHIE DES INTERVENTIONS DE LUTTE CONTRE LE PALUDISME AU BURKINA FASO</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (430 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Ce Webmapping a pour objectif de représenter et d’analyser des données sur le paludisme et les interventions de lutte contre le paludisme au BURKINA FASO à travers une carte interactive accessible en ligne. La démarche adoptée repose sur la préparation et la structuration des données spatiales, leur intégration dans un environnement web ainsi que leur mise en forme cartographique afin d’assurer une lecture claire et intuitive.';
            }
